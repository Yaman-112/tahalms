...
const ALIASES: Record<string, Array<[RegExp, string]>> = {
  IBA: [
    [/16e\s*chapter/i,                         'Statistics for Business'],
  ...
  HT: [
    ...
    [/front[\s_-]*office/i,                    'Managing Front Office Operations'],
    [/house[\s_-]*keeping|housekeeping|room[\s_-]*cleaning|laundry/i, 'House Keeping'],
  ...
  ECA: [
    [/ECED1010|foundations\s*of\s*ece|foundations\s*of\s*early/i, 'Foundations of Early Childhood Education'],
    [/ECED1080|inclusive\s*program|inclusive\s*environment/i,    'Creating Inclusive Programs'],
    [/PSYC1030|infant.*child.*development/i,                     'Infant and Child Development'],
    [/PSYC1000|introduction\s*to\s*psychology/i,                 'Introduction to Psychology'],
    [/SOCI1000|introduction\s*to\s*sociology/i,                  'Introduction to Sociology'],
    [/COMM1010|communications/i,                                 'Communications'],
    [/ECED1020|observation/i,                                    'Observation Skills'],
    [/ECED1030|health.*safety.*nutrition/i,                      'Health, Safety and Nutrition'],
    [/ECED1040|child.*family.*community/i,                       'Child, Family and Community'],
    [/ECED1050|play.*based|play-based/i,                         'Play-Based Early Learning Strategies'],
    [/ECED1060|language.*literacy/i,                             'Language and Literacy'],
    [/ECED1070|guiding.*children/i,                              "Guiding Children's Behaviour"],
    [/ECED1090|special\s*needs/i,                                'Special Needs'],
  ],
  PSW: [
    [/cognitive|mental\s*health|brain\s*inj/i, 'Cognitive / Mental Health Issues and Brain Injuries'],
    [/care\s*planning|restorative|documentation|working\s*in\s*the\s*community/i, 'Care Planning / Restorative Care / Documentation / Working in the Community'],
    [/medication/i,                            'Assisting with Medications'],
    [/mobility|safety/i,                       'Safety and Mobility'],
    [/dying\s*person/i,                        'Assisting the Dying Person'],
    [/family.*growth.*development|growth.*development/i, 'Assisting the Family, Growth and Development'],
    [/personal\s*hygiene|hygiene/i,            'Assisting with Personal Hygiene'],
    [/abuse|neglect/i,                         'Abuse and Neglect'],
    [/household|nutrition|hydration/i,         'Household Management, Nutrition and Hydration'],
    [/body\s*systems/i,                        'Body Systems'],
    [/foundation/i,                            'PSW Foundations'],
    [/dementia|gentle\s*persuasive/i,          'Gentle Persuasive Approaches in Dementia Care'],
    [/health\s*conditions/i,                   'Health Conditions'],
    [/clinical|placement/i,                    'Clinical Placement (Facility)'],
  ],
  MD: [
    [/skin|facial/i,                           'Facials/Skincare'],
    [/eyebrow|nail/i,                          'Nail Care'],
    [/makeup|colour\s*wheel/i,                 'Makeup Artistry'],
    [/wax/i,                                   'Waxing'],
    [/employment\s*prep|business\s*skills|soft\s*skills/i, 'Employment Preparation, Soft Skills & Business Skills'],
    [/salon\s*function|sanitation|infection/i, 'Health & Safety, Sanitation & Infection Prevention'],
  ],
  HAIR: [
    [/cosmetology|professional\s*development|chapter\s*12/i, 'Professional Development'],
    [/hairstyling|haircut|cut/i,               'Cut Hair'],
    [/style|styling/i,                         'Style Hair'],
    [/colour|color|lighten/i,                  'Colour and Lighten Hair'],
    [/perm|wave/i,                             'Permanent Wave Hair'],
    [/relax/i,                                 'Chemically Relax Hair'],
    [/addition/i,                              'Hair Additions'],
  ],
  MOA: [
